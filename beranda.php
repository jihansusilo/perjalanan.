					...
					<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
						...
						<li class="nav-item">
							<a href="lokasi.php" class="nav-link align-middle px-0 text-white">
								<i class="bi-geo-alt-fill"></i></i> <span class="ms-1 d-none d-sm-inline">Lokasi</span>
							</a>
						</li>
					...
					<div class="col-9">
						...
						<div class="card bg-light">
							<div class=" card-body shadow">
								...
								echo $d['nama'];
							?>
							di aplikasi Peduli Diri</h5></center>
							<center><p>Jangan lupa selalu pakai masker dan membawa hand sanitizer.</p></center>
							<center><p>Selalu jaga kesehatan ya di manapun kamu berada :)</p></center>
							<center><p>Ingat kesehatan itu mahal.</p></center>
							<p>
							<center><img src="asset/img/dashboard/lok.png"></center>
							</p>
						</div>
					</div>
				</div>
